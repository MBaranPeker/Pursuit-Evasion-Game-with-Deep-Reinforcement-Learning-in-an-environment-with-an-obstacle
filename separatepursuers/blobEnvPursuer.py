...
MIN_OBSERVATION = 10_000  # Minimum number of steps in a memory to start training
...
###
		...
		new_observation = np.append(obs_E, obs_P, axis=0)
...
#					reward += seen_reward_4
		...
		if observation_num % 50_000 == 9999:
			...
			deep_q.save_network("model_pursuer_1")
			deep_q.save_target_network("targetmodel_pursuer_1")
