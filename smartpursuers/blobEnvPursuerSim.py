...
deep_q.trained_model("targetmodel_pursuer_203")
...
#		print("Step Number : ",observation_num)
		if done == True :
			catch +=1

		if done == True or episode_step == 49:

			catch_list.append(catch)
			observasin_num_list.append(observation_num)
...
print("Captured or Collide Times : ",catch)
plt.plot(episode_num_list, observasin_num_list) 
 

plt.ylabel('Action Number in an Episode') 
